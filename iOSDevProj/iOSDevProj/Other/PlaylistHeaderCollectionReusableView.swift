...
final class PlaylistHeaderCollectionReusableView: UICollectionReusableView {
    ...
    override init(frame: CGRect) {
        ...
        playPlaylistButton.addTarget(self, action: #selector(playAudioButtonTapped), for: .touchUpInside)
    }
    ...
    func configure(with viewModel: PlaylistHeaderViewModel) {
        ...
        imageView.sd_setImage(with: viewModel.headerImage, placeholderImage: UIImage(systemName: "photo"),completed: nil)
    }
}
