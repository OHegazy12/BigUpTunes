...
// https://youtube.com/playlist?list=PL5PR3UyfTWve9ZC7Yws0x6EGjBO2FGr0o, Parts 1-3 of this playlist are sources used to set up connection to the Spotify API as well as Authentication to be able to use Spotify's API in the Auth files.
...
final class APICaller {
    ...
    public func deleteTrackFromUserPlaylist(track: AudioTrack, playlist: Playlist, completion: @escaping (Bool) -> Void) {
